...
object IslScheduleMap2IslScheduleTree {
  protected def createTestConfig() : Option[Config] = {
    ...
    props.setProperty("measurementCommand", "/devel/git_3rd/polyite/polyite/measure_polybench.bash")
    props.setProperty("measurementWorkingDir", "/devel/git_3rd/polyite/polyite/")
    ...
    props.setProperty("irFilesLocation", "/devel/git_3rd/polyite/polyite/polybench-c-4.1")
    ...
    props.setProperty("barvinokBinary", "/devel/git_3rd/polyite/barvinok_binary/count_integer_points")
    props.setProperty("barvinokLibraryPath", "/devel/git_3rd/polyite/barvinok/install/lib")
